...
namespace Exavision.Seasense.Core.IO {
    ...
    public class IniFile
    {
        ...
        /// <param name="commentDelimiter">The commentDelimiter<see cref="string"/>.</param>
        ...
        /// <summary>
        /// Gets or sets the CommentDelimiter
        ...
        private void LoadLine(string line, string section)
        {
            int index = line.IndexOf('=');
