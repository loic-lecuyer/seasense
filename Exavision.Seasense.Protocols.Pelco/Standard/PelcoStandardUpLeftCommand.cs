namespace Exavision.Seasense.Protocols.Pelco.Standard {
    ...
    /// <summary>
    /// Defines the <see cref="PelcoStandardUpLeftCommand" />.
    /// </summary>
    public class PelcoStandardUpLeftCommand : PelcoCommand, IPelcoUpLeftCommand
    {
        /// <summary>
        ...
        /// </summary>
        public override byte CommandByte2 { get; set; } = 0x0C;
