namespace Exavision.Seasense.Protocols.Pelco.Standard {
    ...
    /// <summary>
    /// Defines the <see cref="PelcoStandardLeftCommand" />.
    /// </summary>
    public class PelcoStandardLeftCommand : PelcoCommand, IPelcoLeftCommand
    {
        /// <summary>
        ...
        /// </summary>
        public override byte CommandByte2 { get; set; } = 0x04;
