namespace Exavision.Seasense.Protocols.Pelco.Standard {
    ...
    /// <summary>
    /// Defines the <see cref="PelcoStandardZoomInCommand" />.
    /// </summary>
    public class PelcoStandardZoomInCommand : PelcoCommand, IPelcoZoomInCommand
    {
        /// <summary>
        ...
        /// </summary>
        public override byte CommandByte2 { get; set; } = 0x20;
    }
}
