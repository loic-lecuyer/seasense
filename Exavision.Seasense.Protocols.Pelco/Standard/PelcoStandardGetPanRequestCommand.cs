namespace Exavision.Seasense.Protocols.Pelco.Standard {
    ...
    /// <summary>
    /// Defines the <see cref="PelcoStandardGetPanRequestCommand" />.
    /// </summary>
    public class PelcoStandardGetPanRequestCommand : PelcoCommand, IPelcoGetPanRequestCommand
    {
        /// <summary>
        ...
        /// </summary>
        public override byte CommandByte2 { get; set; } = 0x51;
    }
}
