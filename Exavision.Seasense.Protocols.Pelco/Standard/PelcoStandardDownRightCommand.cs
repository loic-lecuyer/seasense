namespace Exavision.Seasense.Protocols.Pelco.Standard {
    ...
    /// <summary>
    /// Defines the <see cref="PelcoStandardDownRightCommand" />.
    /// </summary>
    public class PelcoStandardDownRightCommand : PelcoCommand, IPelcoDownRightCommand
    {
        /// <summary>
        ...
        /// </summary>
        public override byte CommandByte2 { get; set; } = 0x12;
