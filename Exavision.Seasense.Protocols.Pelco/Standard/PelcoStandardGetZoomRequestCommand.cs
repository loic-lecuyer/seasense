namespace Exavision.Seasense.Protocols.Pelco.Standard {
    ...
    /// <summary>
    /// Defines the <see cref="PelcoStandardGetZoomRequestCommand" />.
    /// </summary>
    public class PelcoStandardGetZoomRequestCommand : PelcoCommand, IPelcoGetZoomRequestCommand
    {
        /// <summary>
        ...
        /// </summary>
        public override byte CommandByte2 { get; set; } = 0x55;
    }
}
