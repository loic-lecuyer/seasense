namespace Exavision.Seasense.Protocols.Pelco.Standard {
    ...
    /// <summary>
    /// Defines the <see cref="PelcoStandardFocusNearContinuousCommand" />.
    /// </summary>
    public class PelcoStandardFocusNearContinuousCommand : PelcoCommand, IPelcoFocusNearContinuousCommand
    {
        /// <summary>
        /// Gets or sets the CommandByte1.
        /// </summary>
        public override byte CommandByte1 { get; set; } = 0x01;
