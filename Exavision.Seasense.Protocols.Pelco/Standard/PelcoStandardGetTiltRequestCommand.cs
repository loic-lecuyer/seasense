namespace Exavision.Seasense.Protocols.Pelco.Standard {
    ...
    /// <summary>
    /// Defines the <see cref="PelcoStandardGetTiltRequestCommand" />.
    /// </summary>
    public class PelcoStandardGetTiltRequestCommand : PelcoCommand, IPelcoGetTiltRequestCommand
    {
        /// <summary>
        ...
        /// </summary>
        public override byte CommandByte2 { get; set; } = 0x53;
    }
}
