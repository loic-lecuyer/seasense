namespace Exavision.Seasense.Protocols.Pelco.Standard {
    ...
    /// <summary>
    /// Defines the <see cref="PelcoStandardDownLeftCommand" />.
    /// </summary>
    public class PelcoStandardDownLeftCommand : PelcoCommand, IPelcoDownLeftCommand
    {
        /// <summary>
        ...
        /// </summary>
        public override byte CommandByte2 { get; set; } = 0x14;
