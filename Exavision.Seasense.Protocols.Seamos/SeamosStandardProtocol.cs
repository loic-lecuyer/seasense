namespace Exavision.Seasense.Protocols.Seamos {
    ...
    public class SeamosStandardProtocol : SeamosProtocol
    {
        ...
        public SeamosStandardProtocol() : base()
        {
            ...
            this.RegisterInstance<SeamosCameraZoomStopRequest, ICameraZoomStopRequest>(() => new SeamosCameraZoomStopRequest() { ChannelByte = 0x02 }, MaterialTarget.ThermalCamera);
            ...
            this.RegisterInstance<SeamosCameraFocusMinusRequest, ICameraFocusMinusRequest>(() => new SeamosCameraFocusMinusRequest() { ChannelByte = 0x02 }, MaterialTarget.ThermalCamera);
            this.RegisterInstance<SeamosCameraFocusPlusRequest, ICameraFocusPlusRequest>(() => new SeamosCameraFocusPlusRequest() { ChannelByte = 0x02 }, MaterialTarget.ThermalCamera);
            this.RegisterInstance<SeamosCameraFocusStopRequest, ICameraFocusStopRequest>(() => new SeamosCameraFocusStopRequest() { ChannelByte = 0x02 }, MaterialTarget.ThermalCamera);
