namespace Exavision.Seasense.Protocols.Seamos.Standard.Camera {
    ...
    /// <summary>
    /// Defines the <see cref="SeamosCameraSetGammaEnabledRequest" />.
    /// </summary>
    public class SeamosCameraSetGammaEnabledRequest : SeamosPascalCommand, ICameraSetGammaEnabledRequest
    {
        /// <summary>
        ...
        /// </summary>
        public override byte CommandByte2 => 0x16;
