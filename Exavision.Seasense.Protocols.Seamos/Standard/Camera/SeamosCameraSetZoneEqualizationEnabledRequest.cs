namespace Exavision.Seasense.Protocols.Seamos.Standard.Camera {
    ...
    /// <summary>
    /// Defines the <see cref="SeamosCameraSetZoneEqualizationEnabledRequest" />.
    /// </summary>
    public class SeamosCameraSetZoneEqualizationEnabledRequest : SeamosPascalCommand, ICameraSetZoneEqualizationEnabledRequest
    {
        /// <summary>
        ...
        /// </summary>
        public override byte CommandByte2 => 0x1E;
