namespace Exavision.Seasense.Protocols.Seamos.Standard.Telemeter {
    ...
    /// <summary>
    /// Defines the <see cref="SeamosTelemeterSetOffRequest" />.
    /// </summary>
    public class SeamosTelemeterSetOffRequest : SeamosPascalCommand, ITelemeterSetOffRequest
    {
        /// <summary>
        ...
        /// </summary>
        public override byte CommandByte2 => 0x06;
